...
public class OperationTest {
    ...
    public static Stream<Arguments> getValidOperations() {
        ...
        for (int i = 0; i < 23; i++) {
            ...
            args.add(Arguments.of(i + "-4", new InputNumber(i), SUBS, new InputNumber(4)));
            args.add(Arguments.of(i + "+4", new InputNumber(i), SUM, new InputNumber(4)));
        }
        ...
        for (int i = 0; i < 23; i++) {
            ...
            args.add(Arguments.of("4-" + i, new InputNumber(4), SUBS, new InputNumber(i)));
            args.add(Arguments.of("4+" + i, new InputNumber(4), SUM, new InputNumber(i)));
        }
